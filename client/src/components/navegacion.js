import { IconDashboard, IconRegistrar, IconHistorial, IconInsumos, IconGestion } from './Icons';
...
export const PESTANAS = [
  ...
  { id: 'gestion', etiqueta: 'Gestión', Icono: IconGestion, soloAdmin: true, disponible: true },
];
